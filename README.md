...
❗❗The backend of this project is already deployed on renderer and it is connected to the frontend so while running this on your local system you need not follow the steps for mongodb just 
